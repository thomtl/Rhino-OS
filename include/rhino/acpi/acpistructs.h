...
#define RHINO_ACPI_ADDRESS_SPACE_SYSTEM_MEM 0
#define RHINO_ACPI_ADDRESS_SPACE_SYSTEM_IO 1
#define RHINO_ACPI_ADDRESS_SPACE_PCI_CONFIG_SPACE 2
#define RHINO_ACPI_ADDRESS_SPACE_EMBEDDED_CONTROLLER 3
#define RHINO_ACPI_ADDRESS_SPACE_SMBUS 4
#define RHINO_ACPI_ADDRESS_SPACE_FUNCTION_FIXED_HARDWARE 0x7F

#define RHINO_ACPI_ACCESS_SIZE_UNDEFINED 0
#define RHINO_ACPI_ACCESS_SIZE_BYTE 1
#define RHINO_ACPI_ACCESS_SIZE_WORD 2
#define RHINO_ACPI_ACCESS_SIZE_DWORD 3
#define RHINO_ACPI_ACCESS_SIZE_QWORD 4
