...
QEMUFLAGS = -m 256M -hda rhino.iso -d cpu_reset -D build/log/qemu.log -fda flp.flp -rtc base=localtime -monitor stdio -soundhw pcspk -vga std -serial file:/dev/stdout #./build/log/com1.out
