...
# -fda flp.flp 
QEMUFLAGS = -m 256M -cdrom rhino.iso -fda flp.flp -d cpu_reset -D build/log/qemu.log -rtc base=localtime -monitor stdio -soundhw pcspk -vga std -serial file:/dev/stdout#./build/log/com1.out
