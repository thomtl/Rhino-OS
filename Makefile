...
initrd:
	rm -f initrd.img
	./user/makeall.sh
	./utils/initrdgen/genrd ./utils/initrdgen/test.txt test.txt ./utils/initrdgen/test1.txt test1.txt ./user/TSH/tsh tsh ./user/init/init init ./user/ls/ls ls ./user/example/example example ./user/cat/cat cat
